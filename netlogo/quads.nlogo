...
;; Observer
to setup
  ca ;; Observer only command; "clear all"
  ask patches
  [
    set pcolor black
  ]
...
;; distancexy x y -> returns the distance of the patches position and the point(x,y)
to draw-distance
...
;; ask patch 0 0 [...]
;; patch is an agent
;; patches is an entire agentset

;; ask patches with [...]
;; subset of the agentset
...
;; Observer
to draw-mouse-distance
  if mouse-down?
  [
    ask patches [set pcolor (distancexy mouse-xcor mouse-ycor)]
  ]
end
